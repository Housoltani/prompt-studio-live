...
export default function AIAcademy() {
  ...
  return (
    <div className="max-w-7xl animate-fade-in mx-auto mt-4 pb-20">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-900/50 to-indigo-900/50 border border-blue-500/30 rounded-3xl p-8 mb-12 text-center relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-400 to-indigo-500"></div>
        <h1 className="text-4xl md:text-5xl font-black text-white mb-4 tracking-tight">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">KI für Anfänger</span> Bootcamp
        </h1>
        <p className="text-slate-300 text-lg max-w-2xl mx-auto">
          Willkommen in der Grundausbildung! Hier lernst du die fundamentalen Werkzeuge kennen, um die Matrix der KI-Generierung zu beherrschen.
        </p>
      </div>
